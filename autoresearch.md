...
- Kept: typed validation scanners return directly on closing delimiters, improving to ~10.94 ms. Index-filling int arrays and four-slot duplicate tracking in the typed map scanner regressed.
