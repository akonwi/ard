	...
	runLexing(t, []lexTest{
...

		{
			...
			want: []token{
				...
				{kind: identifier, line: 1, column: 6, text: "Person"},
				{kind: left_brace, line: 1, column: 13},
				{kind: new_line, line: 1, column: 14},
				...
				{kind: identifier, line: 5, column: 6, text: "Person"},
				{kind: left_brace, line: 5, column: 13},
				{kind: new_line, line: 5, column: 14},

				{kind: fn, line: 6, column: 3},
				{kind: mut, line: 6, column: 6},
				{kind: identifier, line: 6, column: 10, text: "age"},
				{kind: left_paren, line: 6, column: 13},
				{kind: right_paren, line: 6, column: 14},
				{kind: left_brace, line: 6, column: 16},
				{kind: new_line, line: 6, column: 17},

				{kind: at_sign, line: 7, column: 5},
				{kind: identifier, line: 7, column: 6, text: "age"},
				{kind: increment, line: 7, column: 10},
				{kind: number, line: 7, column: 13, text: "1"},
				{kind: new_line, line: 7, column: 14},
