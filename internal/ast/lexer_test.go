	...
	runLexing(t, []lexTest{
		{
			...
			want: []token{
				...
				{kind: space, line: 3, column: 5},
				{kind: identifier, line: 3, column: 6, text: "is"},
				{kind: space, line: 3, column: 8},
				{kind: identifier, line: 3, column: 9, text: "a"},
				{kind: space, line: 3, column: 10},
...

		{
			...
			want: []token{
				...
				{kind: space, line: 1, column: 4},
				{kind: identifier, line: 1, column: 5, text: "x"},
				{kind: space, line: 1, column: 6},
				...
				{kind: space, line: 4, column: 2},
				{kind: equal, line: 4, column: 3},
				{kind: space, line: 4, column: 4},
...

		{
			...
			want: []token{
				...
				{kind: space, line: 1, column: 7},
				{kind: identifier, line: 1, column: 8, text: "is_true"},
				{kind: space, line: 1, column: 15},
...

		{
			...
			want: []token{
				...
				{kind: space, line: 2, column: 1},
				{kind: space, line: 2, column: 2},
		...
		},
		{
			...
			want: []token{
				...
				{kind: space, line: 7, column: 1},
				{kind: space, line: 7, column: 2},
				{kind: identifier, line: 7, column: 3, text: "n"},
				{kind: space, line: 7, column: 4},
				{kind: plus, line: 7, column: 5},
				{kind: space, line: 7, column: 6},
				...
				{kind: space, line: 10, column: 13},
				{kind: left_brace, line: 10, column: 14},
				{kind: space, line: 10, column: 15},
				{kind: identifier, line: 10, column: 16, text: "n"},
				{kind: space, line: 10, column: 17},
				{kind: plus, line: 10, column: 18},
				{kind: space, line: 10, column: 19},
				{kind: number, line: 10, column: 20, text: "1"},
				{kind: space, line: 10, column: 21},
...

		{
			...
			want: []token{
				...
				{kind: space, line: 3, column: 1},
				{kind: space, line: 3, column: 2},
...

		{
			...
			want: []token{
				...
				{kind: space, line: 2, column: 28},
				{kind: equal, line: 2, column: 29},
				{kind: space, line: 2, column: 30},
...

		{
			...
			want: []token{
				...
				{kind: space, line: 3, column: 19},
				{kind: left_brace, line: 3, column: 20},
				{kind: new_line, line: 3, column: 21},

				{kind: space, line: 4, column: 1},
				{kind: space, line: 4, column: 2},
				{kind: space, line: 4, column: 3},
				{kind: space, line: 4, column: 4},
				...
				{kind: space, line: 5, column: 1},
				{kind: space, line: 5, column: 2},
				{kind: space, line: 5, column: 3},
				{kind: space, line: 5, column: 4},
				...
				{kind: space, line: 7, column: 8},
				{kind: fat_arrow, line: 7, column: 9},
				{kind: space, line: 7, column: 11},
...

		{
			...
			want: []token{
				...
				{kind: space, line: 6, column: 3},
				{kind: plus, line: 6, column: 4},
				{kind: space, line: 6, column: 5},
				...
				{kind: space, line: 8, column: 4},
				{kind: slash, line: 8, column: 5},
				{kind: space, line: 8, column: 6},
				...
				{kind: space, line: 9, column: 2},
				{kind: percent, line: 9, column: 3},
				{kind: space, line: 9, column: 4},
		...
		},
		{
			...
			want: []token{
				...
				{kind: space, line: 2, column: 7},
				{kind: equal_equal, line: 2, column: 8},
				{kind: space, line: 2, column: 10},
...

		{
			...
			want: []token{
				...
				{kind: space, line: 4, column: 17},
				{kind: equal, line: 4, column: 18},
				{kind: space, line: 4, column: 19},
				...
				{kind: space, line: 5, column: 10},
				{kind: equal, line: 5, column: 11},
				{kind: space, line: 5, column: 12},
				{kind: not, line: 5, column: 13},
				{kind: space, line: 5, column: 16},
