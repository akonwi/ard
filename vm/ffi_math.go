...
func add(vm *VM, args []*object) (*object, any) {
	if len(args) != 2 {
...
func multiply(vm *VM, args []*object) (*object, any) {
	if len(args) != 2 {
...
func max(vm *VM, args []*object) (*object, any) {
	if len(args) != 2 {
...
func subtract(vm *VM, args []*object) (*object, any) {
	if len(args) != 2 {
...
func divide(vm *VM, args []*object) (*object, any) {
	if len(args) != 2 {
