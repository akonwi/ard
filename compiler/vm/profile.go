...
var exprKindNames = []string{
	"const_void", "const_int", "const_float", "const_bool", "const_str", "panic", "load_local", "call", "call_extern", "make_closure", "call_closure", "spawn_fiber", "fiber_get", "fiber_join", "union_wrap", "match_union", "trait_upcast", "call_trait", "copy", "make_list", "list_at", "list_prepend", "list_push", "list_set", "list_size", "list_sort", "list_swap", "make_map", "map_keys", "map_size", "map_get", "map_set", "map_drop", "map_has", "map_key_at", "map_value_at", "make_struct", "get_field", "int_add", "int_sub", "int_mul", "int_div", "int_mod", "float_add", "float_sub", "float_mul", "float_div", "str_concat", "to_str", "str_at", "str_size", "str_is_empty", "str_contains", "str_replace", "str_replace_all", "str_split", "str_starts_with", "str_ends_with", "to_dynamic", "str_trim", "eq", "not_eq", "lt", "lte", "gt", "gte", "and", "or", "not", "neg", "block", "if", "make_result_ok", "make_result_err", "enum_variant", "match_enum", "match_int", "match_str", "make_maybe_some", "make_maybe_none", "match_maybe", "maybe_expect", "maybe_is_none", "maybe_is_some", "maybe_or", "maybe_map", "maybe_and_then", "match_result", "result_expect", "result_or", "result_is_ok", "result_is_err", "result_map", "result_map_err", "result_and_then", "try_result", "try_maybe",
}
