...
func (r *RuntimeFFIRegistry) RegisterBuiltinFFIFunctions() error {
	...
	if err := r.RegisterValue("DecodeString", vmFFIDecodeString); err != nil {
		return err
	}
	if err := r.RegisterValue("DecodeInt", vmFFIDecodeInt); err != nil {
		return err
	}
	if err := r.RegisterValue("DecodeFloat", vmFFIDecodeFloat); err != nil {
		return err
	}
	...
	if err := r.RegisterValue("DynamicToMap", vmFFIDynamicToMap); err != nil {
		return err
	}
	...
	if err := r.RegisterValue("HexDecode", vmFFIHexDecode); err != nil {
		return err
	}
	return nil
}
