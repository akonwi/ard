...
Benchmarks the full `ard run` / `ard run --target go` path instead of prebuilt binaries:
...
- `cli` mode is useful if you want to include transpilation/build overhead in the Go backend measurement.
