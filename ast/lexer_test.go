	...
	runLexing(t, []lexTest{
...

		{
			...
			want: []token{
				...
				{kind: new_line, line: 3, column: 17},

				{kind: string_, line: 4, column: 1},
				{kind: expr_open, line: 4, column: 2},
				{kind: identifier, line: 4, column: 4, text: "c"},
				{kind: expr_close, line: 4, column: 5},
				{kind: string_, line: 4, column: 7},
				{kind: expr_open, line: 4, column: 7},
				{kind: identifier, line: 4, column: 9, text: "res"},
				{kind: expr_close, line: 4, column: 12},
				{kind: string_, line: 4, column: 14},
